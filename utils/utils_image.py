...
def calculate_convergence(img1, img2):
    mse_num = np.mean((img1-img2)**2)
    mse_denum = np.mean(img2**2)
    return math.sqrt(mse_num/mse_denum)
...
def set_sigma(model_type, test_path):
    if 'MetFaces1_a' in test_path:
        if  'metfaces' in model_type:
            sigma = 130
        elif 'brecahad' in model_type:
            pass
        elif 'afhq' in model_type:
            pass
        elif 'rxrx1' in model_type:
            pass
        elif 'celeba' in model_type:
            pass
